"""
Django settings for OsamuWebPage project.
...
ALLOWED_HOSTS = ['osamukatagiri-production.up.railway.app', 'osamukatagiri.me']
...
ROOT_URLCONF = 'OsamuWebPage.urls'
...
WSGI_APPLICATION = 'OsamuWebPage.wsgi.application'
